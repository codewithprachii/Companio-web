...
const memoryImages = [
    { name: "fish", image: "memory-images/fish_1.png" },
    { name: "turtle", image: "memory-images/turtle_1.png" },
    { name: "dolphin", image: "memory-images/dolphin_1.png" },
    { name: "seahorse", image: "memory-images/seahorse_1.png" },
    { name: "crab", image: "memory-images/crab_1.png" },
    { name: "jellyfish", image: "memory-images/jellyfish_1.png" },
    { name: "starfish", image: "memory-images/starfish_1.png" },
    { name: "whale", image: "memory-images/whale_1.png" }
];
...
const spotLevels = [
    {
        level: 1,
        differences: 5,
        original: "companio_spot_difference_levels/level_2_cow_5_differences/original.png",
        changed: "companio_spot_difference_levels/level_2_cow_5_differences/changed.png",
        spots: [
            { x: 22, y: 25 },
            { x: 63, y: 28 },
            { x: 75, y: 35 },
...

    {
        level: 2,
        differences: 7,
        original: "companio_spot_difference_levels/level_3_icecream_7_differences/original.png",
        changed: "companio_spot_difference_levels/level_3_icecream_7_differences/changed.png",
        spots: [
            { x: 18, y: 22 },
            { x: 50, y: 20 },
            { x: 67, y: 28 },
...

    {
        level: 3,
        differences: 10,
        original: "companio_spot_difference_levels/level_4_bugs_10_differences/original.png",
        changed: "companio_spot_difference_levels/level_4_bugs_10_differences/changed.png",
        spots: [
            { x: 18, y: 28 },
            { x: 38, y: 22 },
            { x: 60, y: 25 },
...
const whatDidYouSeeLevels = [
    {
        level: 1,
        image: "what-did-you-see/level1_living_room.png",
        seconds: 8,
        questions: [
            {
    ...
    {
        level: 2,
        image: "what-did-you-see/level2_kitchen.png",
        seconds: 10,
        questions: [
            {
    ...
    {
        level: 3,
        image: "what-did-you-see/level3_park.png",
        seconds: 12,
        questions: [
            {
